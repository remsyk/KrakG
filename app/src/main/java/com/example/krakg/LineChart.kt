...
class LineChart : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        val anyChartView: AnyChartView = chart
        ...
        val seriesData: List<DataEntry> = ArrayList()
...
class CustomDataEntry : ValueDataEntry {
    ...
    constructor(x: String, value: Number, value2:Number, value3: Number) {
